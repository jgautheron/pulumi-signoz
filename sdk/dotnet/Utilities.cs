...
namespace JGautheron.Pulumi.Signoz
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("JGautheron.Pulumi.Signoz.version.txt");
    ...
    internal sealed class SignozResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SignozResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
